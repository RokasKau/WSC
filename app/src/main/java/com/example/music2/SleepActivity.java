...
public class SleepActivity extends AppCompatActivity {
    ...
    private int currentVideoRes = R.raw.sleep1video;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int userLevel = dbHelper.getUserLevel("sleep");

        List<VideoItem> videoList = new ArrayList<>();
        videoList.add(new VideoItem(R.raw.sleep1video, 1));
        videoList.add(new VideoItem(R.raw.sleep2video, 2));
        videoList.add(new VideoItem(R.raw.sleep3video, 3));
        ...
        startButton.setOnClickListener(v -> {
            Intent intent = new Intent(SleepActivity.this, PlayerActivity.class);
    ...
    private void setAlarm(int hour, int minute) {
        ...
        dbHelper.saveAlarm(hour, minute, true, "sleep");
    }

    private void addExperience(int minutesListened) {
        int currentExp = dbHelper.getUserExperience("sleep");
        int currentLevel = dbHelper.getUserLevel("sleep");
        ...
        dbHelper.updateUserProgress("sleep", currentLevel, currentExp);
        updateProgressUI();
    }

    private void updateProgressUI() {
        int userLevel = dbHelper.getUserLevel("sleep");
        int userExp = dbHelper.getUserExperience("sleep");
